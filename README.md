...
[Jianxiong Zhou](https://scholar.google.com/citations?hl=zh-CN&user=_PCm9QEAAAAJ), and [Ying Wu](http://users.ece.northwestern.edu/~yingwu/). In the IEEE/CVF Winter Conference on Applications of Computer Vision (WACV), 2023.
