...
parser = argparse.ArgumentParser(description='TFE_DCN')
...
parser.add_argument('--model-name', default='TFE_DCN', help='name to save model')
...
parser.add_argument('--use-model',type=str, default='TFE_DCN',help='model used to train the network')
...
parser.add_argument("--MEM", type=str, default='Modality_Enhancement_Module')
parser.add_argument("--TFE_DC", type=str, default='TFE_DC_Module')